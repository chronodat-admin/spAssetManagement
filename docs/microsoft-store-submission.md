...
- [ ] Bump `version` in `config/package-solution.json` before each store upload (currently **1.0.0.16**).
...
Current package version: **1.0.0.16** (update `config/package-solution.json` before each store upload).
