...
- [ ] Bump `version` in `config/package-solution.json` before each store upload (currently **1.0.0.15**).
...
Current package version: **1.0.0.15** (update `config/package-solution.json` before each store upload).
