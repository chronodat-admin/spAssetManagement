...
import { TagRegular, BuildingRegular, LocationRegular } from '@fluentui/react-icons';
      ...
      return (
        <>
          <LookupListManager
            ...
            onChanged={onChanged}
          />
          <SubCategoryListManager riskService={assetService} settings={settings} categories={categories} onChanged={onChanged} />
        </>
      );
    case 'vendors':
      return (
