import type { AssetControlLinkType } from '../models/IAssetControlLink';
 ...
 */
export interface IAssetControlLinkSeed {
  riskTitle: string;
  frameworkCode: string;
  controlCode: string;
  linkType: AssetControlLinkType;
  rationale: string;
}

export const ASSET_CONTROL_LINK_SEED_DATA: IAssetControlLinkSeed[] = [
  {
