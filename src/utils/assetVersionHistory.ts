...
export const ASSET_VERSION_TRACKED_FIELDS: Array<{ key: string; label: string }> = [
  ...
  { key: 'RiskResponse', label: 'Vendor' },
  { key: 'RiskCategory', label: 'Category' },
  { key: 'RiskSubCategory', label: 'Sub-Category' },
  { key: 'riskBusiness', label: 'Business' },
  { key: 'RiskProject', label: 'Project' },
  { key: 'RiskProfileType', label: 'Asset Type' },
  { key: 'RiskStrategy', label: 'Location' },
  { key: 'AssignedTo', label: 'Assigned To' },
  { key: 'DateRiskIdentified', label: 'Purchase Date' },
