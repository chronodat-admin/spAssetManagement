...
const STORAGE_PREFIX = 'asset-mgmt-subscription-status-v1';

/** How long a successful subscription status is considered fresh before calling the API again. */
export const SUBSCRIPTION_STATUS_FRESH_MS = 60 * 60 * 1000; // 60 minutes
 ...
 */
export const SUBSCRIPTION_STATUS_GRACE_MS = 7 * 24 * 60 * 60 * 1000; // 7 days
